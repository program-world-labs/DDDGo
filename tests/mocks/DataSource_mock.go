...
func (m *MockIDataSource) Create(ctx context.Context, e dto.IRepoEntity) (dto.IRepoEntity, error) {
	m.ctrl.T.Helper()
...
func (m *MockIDataSource) Delete(ctx context.Context, e dto.IRepoEntity) error {
	m.ctrl.T.Helper()
...
func (m *MockIDataSource) GetByID(ctx context.Context, e dto.IRepoEntity) (dto.IRepoEntity, error) {
	m.ctrl.T.Helper()
...
func (m *MockIDataSource) Update(ctx context.Context, e dto.IRepoEntity) (dto.IRepoEntity, error) {
	m.ctrl.T.Helper()
...
func (m_2 *MockIDataSource) UpdateWithFields(ctx context.Context, e dto.IRepoEntity, m []string) (dto.IRepoEntity, error) {
	m_2.ctrl.T.Helper()
