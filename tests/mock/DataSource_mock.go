...
func (m *MockIDataSource) Create(ctx context.Context, e domain.IEntity) (domain.IEntity, error) {
	m.ctrl.T.Helper()
...
func (m *MockIDataSource) Delete(ctx context.Context, e domain.IEntity) error {
	m.ctrl.T.Helper()
...
func (m *MockIDataSource) GetByID(ctx context.Context, e domain.IEntity) (domain.IEntity, error) {
	m.ctrl.T.Helper()
...
func (m *MockIDataSource) Update(ctx context.Context, e domain.IEntity) (domain.IEntity, error) {
	m.ctrl.T.Helper()
...
func (m_2 *MockIDataSource) UpdateWithFields(ctx context.Context, e domain.IEntity, m []string) (domain.IEntity, error) {
	m_2.ctrl.T.Helper()
...
// Delete mocks base method.
func (m *MockICacheDataSource) Delete(ctx context.Context, e domain.IEntity) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, e)
	ret0, _ := ret[0].(error)
	return ret0
...
func (m *MockICacheDataSource) Get(ctx context.Context, e domain.IEntity) (domain.IEntity, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, e)
	ret0, _ := ret[0].(domain.IEntity)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockICacheDataSourceMockRecorder) Get(ctx, e interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockICacheDataSource)(nil).Get), ctx, e)
}

// Set mocks base method.
func (m *MockICacheDataSource) Set(ctx context.Context, e domain.IEntity) (domain.IEntity, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Set", ctx, e)
	ret0, _ := ret[0].(domain.IEntity)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockICacheDataSourceMockRecorder) Set(ctx, e interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockICacheDataSource)(nil).Set), ctx, e)
}
