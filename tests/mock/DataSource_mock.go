...
func (m *MockICacheDataSource) Get(ctx context.Context, e entity.IEntity) (entity.IEntity, error) {
	m.ctrl.T.Helper()
...
func (m *MockICacheDataSource) Set(ctx context.Context, e entity.IEntity) (entity.IEntity, error) {
	m.ctrl.T.Helper()
